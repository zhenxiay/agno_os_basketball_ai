...
An AI-driven **Basketball Analytics App** built on [Agno framework](https://docs.agno.com/) that provides insights and analysis for teams and player performance of NBA.
...
Built on the [Agno framework](https://docs.agno.com/), it leverages the power of Large Language Model and the tools from the open source project from [Basketball Intelligence](https://github.com/zhenxiay/BasketIntelligence) to deliver insightful and actionable basketball intelligence.
