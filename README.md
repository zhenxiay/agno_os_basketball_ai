...
Built on the [Agno framework](https://docs.agno.com/), it leverages the power of Large Language Model and the tools from the open source project for [Basketball Intelligence](https://github.com/zhenxiay/BasketIntelligence) to deliver insightful and actionable basketball intelligence.
